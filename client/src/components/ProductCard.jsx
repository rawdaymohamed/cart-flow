...
const ProductCard = ({ product }) => {
	...
	return (
		<div className='flex w-full relative flex-col overflow-hidden rounded-lg border border-slate-700 bg-slate-800 shadow-lg'>
			...
			<div className='mt-4 px-5 pb-5'>
				...
				<button
					className='flex items-center justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-center text-sm font-medium
					 text-white hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 w-full'
